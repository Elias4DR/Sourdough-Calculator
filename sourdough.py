...
flour = st.number_input("Flour (g)", min_value=100, max_value=2000, value=500)
hydration = st.slider("Hydration %", 50, 85, 70)
starter_pct = st.slider("Starter %", 10, 30, 20)
salt_pct = st.slider("Salt %", 1, 3, 2)
